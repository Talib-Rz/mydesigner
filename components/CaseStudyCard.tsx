...
export default function CaseStudyCard({
  ...
  if (variant === 'small') {
    return (
      <Link href={`/case-studies#study-${id}`} className="group block cursor-pointer">
        <motion.div
    ...
    <Link href={`/case-studies#study-${id}`} className="group block cursor-pointer">
      ...
      >
        ...
        <div className="p-10 flex flex-col flex-1">
          ...
          <div className="inline-flex items-center gap-2 text-primary-700 font-semibold hover:text-primary-800 transition-colors">
